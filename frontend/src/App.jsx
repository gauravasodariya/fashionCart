...
class AppErrorBoundary extends React.Component {
  ...
  render(){
    if(this.state.hasError){
      return <div style={{ padding:'2rem', maxWidth:'900px', margin:'2rem auto', background:'#fff', borderRadius:'8px', boxShadow:'0 4px 6px rgba(0,0,0,0.1)' }}>
        <h2 style={{ color:'#dc3545' }}>Something went wrong</h2>
        <pre style={{ whiteSpace:'pre-wrap', color:'#611a15' }}>{String(this.state.error?.message||this.state.error)}</pre>
      </div>;
    }
